...
<template>
  <div class="relative p-8 min-h-full select-none pb-device-container">
    ...
    <div class="-mx-2">
      <div v-if="!serverStore.records.length" class="py-20">
        ...
        <!-- <div v-if="helpShow" class="pt-5 text-center">
                    <div class="inline-block p-6 leading-8 text-left bg-gray-100 rounded-lg">
      ...
      <div v-else class="flex flex-wrap">
        <div
          ...
          class="p-3 w-full lg:w-1/2 2xl:w-1/3"
        >
          <div class="p-4 rounded-xl border shadow">
            <div class="flex items-center">
              <div class="flex-grow">
                <div class="inline-block mr-4">
                  <a-tooltip :content="typeName(record.type as string)">
                    <div class="inline-block">
                      <i
                        v-if="record.type === EnumServerType.CLOUD"
                        class="iconfont icon-network"
                      ></i>
                      <i
                        v-else-if="record.type === EnumServerType.LOCAL"
                        class="iconfont icon-desktop"
                      ></i>
                      <i
                        v-else-if="record.type === EnumServerType.LOCAL_DIR"
                ...
                <div class="inline-block mr-4">
                  {{ record.title }}
                  <div class="inline-block px-3 bg-gray-100 rounded-3xl">
                    v{{ record.version }}
                  </div>
                </div>
              </div>
